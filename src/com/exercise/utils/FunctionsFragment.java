...
public class FunctionsFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<FuncGroup> funcList = new ArrayList<FuncGroup>();

        funcList.add(new FuncGroup(getActivity(), R.string.dialer, R.string.dialer_desc, 
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        mCallback.onArticleSelected(l, v, position, id);
